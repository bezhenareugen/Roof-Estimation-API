...
";
    ...
    public static readonly string ResetPasswordEmail = @"
    <!DOCTYPE html>
    <html lang=""en"" xmlns=""http://www.w3.org/1999/xhtml"" xmlns:v=""urn:schemas-microsoft-com:vml"" xmlns:o=""urn:schemas-microsoft-com:office:office"">
    <head>
      <meta charset=""utf-8""> <!-- utf-8 works for most cases -->
              ...
              <table>
                <tr>
                  <td>
                    <div class=""text"" style=""text-align: center;"">
                      <p>Hello {{Name}}</p>
                      <p>If you are request reset password. Please click the button below.</p>
                      <p>If you didn't request, please call our support</p>
                    </div>
                  </td>
                </tr>
              </table>
            ...
            <td valign=""middle"" class=""hero bg_white"" style=""padding-top: 48px"">
              <table>
                <tr>
                  <td>
                    <div class=""text"" style=""text-align: center;"">
                      <a href=""{{resetPasswordLink}}"" class=""btn btn-primary"" style=""padding-left: 24px; padding-right: 24px"">Reset Password</a>
                    </div>
                  </td>
                </tr>
              </table>
